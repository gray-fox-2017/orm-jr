...
// SQL Statement
var CT_STUDENTS = `CREATE TABLE IF NOT EXISTS students (id INTEGER PRIMARY KEY AUTOINCREMENT, first_name VARCHAR(100) UNIQUE, last_name VARCHAR(100), cohorts_id INTEGER REFERENCES cohorts(id))`;
